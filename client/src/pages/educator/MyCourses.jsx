  ...
  return courses ? (
    <div className='h-screen  flex flex-col items-start justify-between  md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='w-full'>
        ...
        <div className='flex felx-col items-center max-w-4xl overflow-hidden rounded-md bg-white border border-gray-500/20 text-sm  text-left'>
            ...
            <tbody>
              {
                courses.map((course, index)=>{
                 return  <tr key={course._id} className='border-b border-gray-500/20'>
                    ...
                    <td  className='px-4 py-3'>{course.enrolledStudents.length}
